...
export default function CategoryItem(props) {
  ...
  return (
    ...
    >
      <div className="p-2 sm:p-4 border-2 border-black bg-white bg-opacity-80 group-hover:bg-neutral-500 group-hover:text-white flex flex-wrap items-center grow-0">
        <div>
